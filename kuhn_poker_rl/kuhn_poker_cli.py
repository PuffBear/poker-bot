"""
Kuhn Poker CLI - Play against the CFR-trained bot in the terminal
"""
...
class KuhnPokerCLI:
    ...
    def load_or_train_bot(self):
        ...
        if os.path.exists("kuhn_poker_strategy.pkl"):
            ...
            print("No saved strategy found. Training bot...")
            print("This may take a moment...")
            self.trainer.train(iterations=50000)
    ...
    def display_game_state(self, player_card, bot_card_hidden, history, pot, current_player, bot_card=None):
        ...
        if bot_card_hidden:
            print(f"Bot's card: [Hidden]")
        else:
            print(f"Bot's card: {self.card_symbols[bot_card]}")
    ...
    def play_game(self):
        ...
        if payoff > 0:
            ...
            print(f"Bot wins! You lose {abs(payoff)} chips.")
    ...
    def run(self):
        ...
        self.clear_screen()
        print("=" * 60)
        print("       Welcome to Kuhn Poker vs CFR Bot!")
        print("=" * 60)
        print("\nRules:")
        ...
        print("\nThe bot has been trained to play Nash equilibrium strategy!")
    ...
    def view_statistics(self):
        ...
        if self.games_played > 0:
            ...
            if player_avg > 0:
                ...
                print("\nThe bot is exploiting your play style.")
            else:
    ...
    def view_strategy(self):
        ...
        self.clear_screen()
        print("=" * 60)
        print("              BOT'S STRATEGY (Nash Equilibrium)")
        print("=" * 60)
        ...
        print("\n" + "-" * 60)
        print("Key insights:")
        print("- Jack: Bluffs occasionally, always folds to bets")
        print("- Queen: Plays cautiously, sometimes calls bets")
        print("- King: Bets for value, always calls when facing bets")
